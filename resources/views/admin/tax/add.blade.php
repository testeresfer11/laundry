      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" id="add-tax" action="{{route('admin.tax.add')}}" method="POST" enctype="multipart/form-data">
              @csrf
              <fieldset>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control @error('label') is-invalid @enderror" id="exampleInputName" placeholder="Label" name="label">
                            @error('label')
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" class="form-control @error('percentage') is-invalid @enderror" id="exampleInputpercentage" placeholder="Percentage" name="percentage" min="0" max="100">
                            @error('label')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
