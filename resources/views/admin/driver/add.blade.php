        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="add-driver" action="{{route('admin.driver.add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6 select_country_code">
                                        ...
                                        <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone" placeholder="Phone Number" name="phone_number" value="" pattern="\d*" inputmode="numeric" 
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control @error('license_number') is-invalid @enderror"  placeholder="License Number" name="license_number">
    ...
    $("#add-driver").submit(function(e){
        ...
        messages: {
            ...
            password:{
                ...
                minlength:"Password name must consist of at least 8 characters"
            },
            dob: {
                required: "Date of birth is required.",
                dobValidation: "You must be at least 18 years old." // Custom error message for DOB validation
            }
        },
