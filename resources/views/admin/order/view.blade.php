    ...
    @if(!orderStatusCheck($order->id,'Cancelled'))
        <div class="col-lg-12">
            <div class="progress-bar mb-5">
                ...
                <div class="six-step">
                    <div class="step-indicator {{orderStatusCheck($order->id,'Assign Delivery Driver') ? 'active' : ''}}">
                        <div class="check-icon ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                                class="bi bi-check-lg" viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="line-title mt-2">
                        <p class="mb-0">Assign Delivery <br> Driver</p>
                    </div>
                </div>
    ...
    @if(orderStatusCheck($order->id,'Cancelled'))
        ...
        <div class="card">
            <div class="card-body py-0">
                <div class="row">
                        <div class="col-lg-12 text-danger text-decoration-underline">
                            Cancelled Reason :- {{$order->declineReason ? $order->declineReason->reason : ''}}
                        </div>
                    </div>
                </div>
        </div>
    ...
    <div class="row">
        ...
        @if($order->status == "Requested")
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-primary mr-2 orderStatusChange" data-id="{{$order->id}}" data-value="Accepted">Accept</button>
                <button class="btn btn-danger reject" data-id="{{$order->id}}" data-value="Cancel">Cancel</button>
            </div>
        @elseif($order->status == "Accepted")
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2" data-bs-toggle="modal" data-bs-target="#assign_driver">Assign Driver</button>
            </div>
        @elseif($order->status == "Assign Driver")
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2 orderStatusChange" data-id="{{$order->id}}" data-value="Arrived"  >Arrived</button>
            </div>
        @elseif($order->status == "Arrived")
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2 orderStatusChange" data-id="{{$order->id}}" data-value="Approved" >Approved</button>
            </div>
        @elseif($order->status == "Paid")
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2 orderStatusChange" data-id="{{$order->id}}" data-value="In Progress" >In Progress</button>
            </div>
        @elseif($order->status == "In Progress")
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2 orderStatusChange" data-id="{{$order->id}}" data-value="Ready" >Ready</button>
            </div>  
        @elseif($order->status == "Ready" && $order->delivery_driver_id == null && $order->pickup_driver_id !== null && $order->delivery_status == 1)
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2" data-bs-toggle="modal" data-bs-target="#assign_driver">Assign Driver</button>
            </div>
        @elseif($order->status == "Rejected" && $order->delivery_driver_id == null && $order->pickup_driver_id !== null && $order->delivery_status == 1)
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2" data-bs-toggle="modal" data-bs-target="#assign_driver">Assign Driver</button>
            </div>
        @elseif($order->status == "Received")
            <div class="col-12 d-flex justify-content-end mt-3">
                <button class="btn btn-success mr-2 orderStatusChange" data-id="{{$order->id}}" data-value="Approved" >Approve</button>
                <button class="btn btn-danger mr-2 reject" data-id="{{$order->id}}" data-value="Reject" >Reject</button>
            </div>  
        @endif
