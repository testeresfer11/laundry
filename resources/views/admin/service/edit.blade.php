      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" id="edit-service" action="{{route('admin.service.edit',['id'=>$service->id])}}" method="POST" enctype="multipart/form-data">
              @csrf
              <fieldset>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputName" placeholder="Name" name="name" value="{{$service->name}}">
                            @error('name')
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" class="form-control @error('first_name') is-invalid @enderror" cols="30" rows="5">{{$service->description}}</textarea>
                        </div>
                    </div>
                </div>
              </fieldset>
