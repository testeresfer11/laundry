...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Customer Address</li>
      </ol>
    </nav>
</div>
@endsection
...
<div>
    <div class="row">
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Customer Address</h4>
                <form class="forms-sample" id="edit-customer-address" action="{{route('admin.customer.address.edit',['id' => $user->id])}}" method="POST">
                @csrf
                <input type="hidden" value="{{$address['id']}}" name="address_id">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('house_no') is-invalid @enderror" id="house_no" placeholder="House No" name = "house_no" value="{{$address['house_no'] ?? ''}}">
                                    @error('house_no')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('landmark') is-invalid @enderror" id="landmark" placeholder="Landmark" name = "landmark" value="{{$address['landmark'] ?? ''}}">
                                    @error('landmark')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" placeholder="Address" name = "address" value="{{$address['address'] ?? ''}}">
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror" id="exampleInputCity" placeholder="City" name="city" value="{{$address['city'] ?? ''}}">
                                    @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('state') is-invalid @enderror" id="exampleInputState" placeholder="State" name="state" value="{{$address['state'] ?? ''}}">
                                    @error('state')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="country" id="exampleInputCountry" class="form-control @error('country') is-invalid @enderror" >
                                        ...
                                        @foreach (getCommonList('country') as $key => $value)
                                            <option value="{{$value}}" {{$address['country'] == $value ?'selected':''}}>{{$value}}</option>
                                        @endforeach
                                    </select>
                    ...
                    <input type="hidden" id="exampleInputLatitude" name="lat" value="{{$address['lat'] ?? ''}}">
                    <input type="hidden" id="exampleInputLongitude" name="long" value="{{$address['long'] ?? ''}}">
                    <div class="address-item default-address mt-2">
                        <input type="checkbox" id="setAsDefault" name="default" {{$address['default'] == 1 ? 'checked' : ''}}>
...
<script>
    $(document).ready(function() {
        ...
        $("#edit-customer-address").submit(function(e){
            e.preventDefault();
        }).validate({
            rules: {
                address: {
