        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="add-promotion" action="{{route('admin.promotion.add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control @error('discount') is-invalid @enderror" id="exampleInputDiscount" placeholder="Discount" name="discount" min="1" max="100" >
                                        @error('discount')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="date" class="form-control @error('exp_date') is-invalid @enderror" id="exampleInputExpDate"  name="exp_date" min="{{date('Y-m-d')}}">
                                        @error('exp_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control @error('min_order') is-invalid @enderror" id="exampleInputMinOrder" placeholder="Min Order" name="min_order" min="1" max="1000">
                                        @error('min_order')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                <div class="row">   
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control @error('max_discount') is-invalid @enderror" id="exampleInputMaxDiscount" placeholder="Max Discount" name="max_discount" min="1" max="10000">
                                        @error('max_discount')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
